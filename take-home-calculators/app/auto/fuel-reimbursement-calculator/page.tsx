...
import FuelReimbursementCalculator from "@/components/FuelReimbursementCalculator";
import { absoluteUrl } from "@/lib/paths";
import { breadcrumbSchema, calculatorSchema, buildJsonLd } from "@/lib/schema";

const TITLE = "Fuel Reimbursement Tax Calculator — New vs Old Regime India";
const DESCRIPTION = "Is your fuel and maintenance reimbursement taxable? Under the new regime, all reimbursements are fully taxable. Calculate your exact tax impact.";
const URL = "/auto/fuel-reimbursement-calculator";
