...
import CTCCarBenefitCalculator from "@/components/CTCCarBenefitCalculator";
import { absoluteUrl } from "@/lib/paths";
import { breadcrumbSchema, calculatorSchema, buildJsonLd } from "@/lib/schema";

const TITLE = "CTC Car Benefit Calculator — Cash vs Lease vs Company Car India";
const DESCRIPTION = "Compare cash car allowance, car lease, and company-provided car. Find which option gives you the highest annual benefit after tax. FY 2025-26.";
const URL = "/auto/ctc-car-benefit-calculator";
