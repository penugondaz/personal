...
import CarLeaseVsBuyCalculator from "@/components/CarLeaseVsBuyCalculator";
import { absoluteUrl } from "@/lib/paths";
import { breadcrumbSchema, calculatorSchema, buildJsonLd } from "@/lib/schema";

const TITLE = "Car Lease vs Buy Calculator India — Which is Better After Tax?";
const DESCRIPTION = "Compare total cost of company car lease vs buying with a car loan. Includes pre-tax lease benefit, EMI, depreciation, and residual value. FY 2025-26.";
const URL = "/auto/car-lease-vs-buy-calculator";
