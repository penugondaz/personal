...
export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: absoluteUrl("/overtime-calculator") },
  openGraph: { title, description, url: absoluteUrl("/overtime-calculator") },
};
    ...
    <main className="mx-auto max-w-3xl px-6 py-10 sm:py-14">
      ...
      <section className="mt-12">
        ...
        <ul className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
          ...
          <li>
            <Link href="/salary-hike-calculator" className="block rounded-md border border-rule bg-surface px-4 py-3 text-center text-sm font-medium text-brand hover:border-brand">
