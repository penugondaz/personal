...
const TITLE = "Rent vs Buy Calculator India — Which is Better in 2026?";
const DESCRIPTION = "Should you rent or buy a home? Compare 20-year net worth under both scenarios accounting for EMI, property appreciation, rent escalation and investment returns.";
const URL = "/real-estate/rent-vs-buy-calculator";
...
export const metadata: Metadata = {
  ...
  keywords: ['rent vs buy calculator india', 'is it better to rent or buy india', 'rent or buy home calculator'],
};
