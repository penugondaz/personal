...
import PropertyAppreciationCalculator from "@/components/PropertyAppreciationCalculator";
import { absoluteUrl } from "@/lib/paths";
import { breadcrumbSchema, calculatorSchema, buildJsonLd } from "@/lib/schema";

const TITLE = "Property Appreciation Calculator India — Future Value of Your Home";
const DESCRIPTION = "Project the future value of your property with city-wise appreciation rates. See year-by-year growth for Mumbai, Bengaluru, Hyderabad, Delhi NCR, Pune and more.";
const URL = "/real-estate/property-appreciation-calculator";
...
export const metadata: Metadata = {
  ...
  keywords: ['property appreciation calculator india', 'real estate return calculator india', 'property value growth calculator'],
};
