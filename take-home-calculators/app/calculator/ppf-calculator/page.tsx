...
export const metadata: Metadata = {
  title,
  description,
  alternates: { canonical: absoluteUrl("/calculator/ppf-calculator") },
  openGraph: { title, description, url: absoluteUrl("/calculator/ppf-calculator") },
};
    ...
    <main className="mx-auto max-w-3xl px-6 py-10 sm:py-14">
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 text-ink-soft">
          ...
          <Link href="/calculator/epf-calculator" className="text-brand hover:underline">
