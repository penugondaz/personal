    ...
    <main className="mx-auto max-w-3xl px-6 py-10 sm:py-14">
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 text-ink-soft">
          ...
          every month without any action on your part. The EPF rate ({(EPF_INTEREST_RATE_FY2025_26*100).toFixed(2)}%) is
          also higher than PPF ({(PPF_INTEREST_RATE*100).toFixed(1)}%), so for most salaried people, EPF
          already forms the core of retirement savings.
        </p>
        <p className="mt-3 text-ink-soft">
          The real decision is whether to supplement with <strong>VPF</strong> (more EPF at the same
          8.25% rate, but locked until resignation/retirement) or <strong>PPF</strong> (slightly
          lower rate but fully tax-free beyond any threshold, accessible after 15 years, and
          available as a loan in years 3–6). PPF also works for self-employed individuals and
          as a savings vehicle for children.
        </p>
      </section>
