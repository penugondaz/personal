...
description: "EPFO has started crediting 8.25% annual interest for FY2025-26 to over 34 crore provident fund accounts. Here's how members can check their updated PF balance and what to do if the interest is not yet visible."
...
### Check Through the EPFO Member Passbook Portal
...
Members can also use **Passbook Lite** for a quick summary of recent contributions, withdrawals and current balance without completing the full login process.

The **UMANG app** also allows users to view their PF balance, track contributions, file claims and download account statements.
...
The rollout of EPFO's new CITES platform has enabled the organisation to credit annual interest much earlier than in previous years, benefiting millions of subscribers. Members can check their updated balances through the EPFO Passbook portal, Passbook Lite or the UMANG app. Even if the interest is not immediately visible, subscribers remain entitled to the full amount under EPF rules, and the balance will be updated as the system completes processing.
```
